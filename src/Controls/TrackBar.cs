...
namespace Rejive
{
	...
	/// <summary>
	///	  <para>
	///		TrackBar represents an advanced track bar that is very better than the 
	///		standard trackbar.
	///   </para>
	///   <para>
	///   TrackBar supports the following features:
	///   <list type="bullet">
	...
	///     <item><c>You can change <see cref="TrackBar.TickColor"/>, <see cref="TrackBar.TickFrequency"/>, <see cref="TrackBar.TickHeight"/>.</c></item> 
	///     <item><c>You can change <see cref="TrackBar.TrackerColor"/> and <see cref="TrackBar.TrackerSize"/>.</c></item> 
	///     <item><c>You can change <see cref="TrackBar.TrackLineColor"/> and <see cref="TrackBar.TrackLineHeight"/>.</c></item> 	
	...
	///   </para>
	/// </summary>
	[Description("TrackBar represents an advanced track bar that is very better than the standard trackbar.")]
	[ToolboxBitmap(typeof(TrackBar),"Editors.TrackBar.TrackBar.bmp")]
	[Designer(typeof(TrackBarDesigner))]
	[DefaultProperty("Maximum")]
	[DefaultEvent("ValueChanged")]	
	public class TrackBar : System.Windows.Forms.Control
	{	
		...
		/// <summary>
		/// Constructor method of <see cref="TrackBar"/> class
		/// </summary>
		public TrackBar()
		{
		...
		/// </summary>
		/// <remarks>
		/// For a <see cref="TrackBar"/> with a large range of values between the <see cref="Minimum"/> and the 
		...
		/// <value>The minimum value for the <see cref="TrackBar"/>. The default value is 0.</value>
		...
		/// </summary>
		/// <remarks>You can use the <see cref="SetRange"/> method to set both the <see cref="Maximum"/> and <see cref="Minimum"/> properties at the same time.</remarks>
		/// <value>The maximum value for the <see cref="TrackBar"/>. The default value is 10.</value>
		...
		{
			TrackBarDrawStyleHelper.DrawAquaPillSingleLayer(g, drawRect,_trackLineColor,_orientation);
		}
		...
		{
			TrackBarDrawStyleHelper.DrawAquaPill(g, trackerRect,_trackerColor,_orientation);
		}
